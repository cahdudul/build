...
update:
	...
	cat ${PORT_ROOT}/smali/sourcechange.txt ${PORT_ROOT}/smali_last/sourcechange.txt | sort | uniq > ${PORT_ROOT}/device/sourcechange.txt
	${PORT_TOOLS}/patch_color_framework.sh ${PORT_ROOT}/smali_last/color ${PORT_ROOT}/smali/color ${PWD}/smali/ ${PORT_ROOT}/device/sourcechange.txt
